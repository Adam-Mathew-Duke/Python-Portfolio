...
for word in faruq_quotes_list[quote].split():
    ...
    if word.isupper() and len(word) >= 2:
        string += ' <font style=color:'+'white'+';background:'+background_colors[random.randint(0,len(background_colors)-1)]+';font-size:14px;>'+word+'</font>'
    ...
    # other words are printed out as normal
        ...
        string += ' <font style=display:inline;font-size:12px;>'+word+'</font>'
